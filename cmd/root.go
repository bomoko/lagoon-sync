...
func init() {
	...
	persistentFlags.StringVar(&cfgFile, "config", "", "config file (default is $HOME/.lagoon-sync.yaml)")

	// persistentFlags.StringVar(&project, "project", "", "The project name")
	// viper.BindPFlag("project", persistentFlags.Lookup("project"))
	// persistentFlags.StringVar(&environment, "environment", "", "The environment name")
